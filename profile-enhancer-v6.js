...
const MODE='anime_tracker_mode_v2';
...
const snapshot=()=>{const out={};for(const k of KEYS){const v=localStorage.getItem(k);if(v!==null)out[k]=v}return out};
...
function setMode(v){if(v)localStorage.setItem(MODE,v);else localStorage.removeItem(MODE)}
