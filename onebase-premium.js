...
function cardFlags(x){const a=[];if(x.state==='viendo')a.push('is-watching');if(x.state==='abandonado')a.push('is-abandoned');if(x.favorite)a.push('is-favorite');if(Number(x.score)===10)a.push('is-perfect');return a.join(' ')}
